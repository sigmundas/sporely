...
class ReferenceLibraryManagerDialog(QDialog):
    ...
    def __init__(
        ...
        *,
        ...
        # Retained only as ignored constructor compatibility for older callers.
        del curation_attestation_version, curation_attestation_text
    ...
    def _build_detail_pane(self) -> QWidget:
        ...
        self.copy_curated_btn = QPushButton(self.tr("Copy a shared contribution…"))
    ...
    def _on_copy_curated_clicked(self) -> None:
        if self._cloud_client is None or self._sporely_taxon_id is None:
            return
        from .curated_reference_catalogue_dialog import SharedReferenceCatalogueDialog
        dialog = SharedReferenceCatalogueDialog(
