    ...
    *,
    ...
    try:
        conn.execute(
            ...
            """,
            (
                image_id, 1, str(filepath), image_type, sort_order,
...
class _PushHarness:
    ...
    def __init__(self, monkeypatch, db_path):
        ...
        remote_images = [_remote_image_row()]
        ...
        def fake_push_images(client_arg, obs, cloud_id, *, prepare_images_cb=None, **kwargs):
